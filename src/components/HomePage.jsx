...
export default function HomePage() {
  ...
  const features = [
  {
    ...
    detailedDesc: 'Track every transaction you make to understand where your money goes and manage it better.',
  ...
  },
  {
    ...
    detailedDesc: 'Get intelligent insights and trends from your spending data to make informed financial decisions.',
  ...
  },
  {
    ...
    detailedDesc: 'Visualize your income, expenses, and category-wise breakdown through rich charts.',
  ...
  },
  {
    ...
    title: 'Budget Goals',
    desc: 'Stay on track',
    detailedDesc: 'Set custom budget goals, track your progress, and receive alerts when you’re near limits.',
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16 max-w-5xl">
            {features.map((feature, index) => (
              <FeatureCard
                ...
                title={feature.title}
                desc={feature.desc}
                detailedDesc={feature.detailedDesc}
                color={feature.color}
              />
        ))}
