      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen text-center px-4">
        ...
        >
          <div className="m-8 relative" style={{ animationDelay: "0.2s" }}>
            ...
            <div
              className="absolute top-2 left-8 w-2 h-2 bg-yellow-400 rounded-full animate-bounce"
              style={{ animationDelay: "0.5s" }}
            ></div>
            <div
              className="absolute top-8 right-4 w-3 h-3 bg-pink-400 rounded-full animate-bounce"
              style={{ animationDelay: "1s" }}
            ></div>
            <div
              className="absolute bottom-4 left-4 w-2 h-2 bg-blue-400 rounded-full animate-bounce"
          ...
          <p className="text-xl md:text-2xl text-gray-300 mb-12 max-w-3xl leading-relaxed">
            ...
            , and
            <span className="text-pink-300 font-semibold animate-pulse">
              {" "}
              smart automation
            </span>
            .
            ...
            {features.map((feature, index) => {
              ...
              return (
                <Link to={feature.route} key={index}>
                  ...
                  >
                    <div
                      className={`w-12 h-12 mx-auto mb-4 rounded-2xl bg-gradient-to-br ${
                        feature.color
                    ...
                    <div
                      className={`mt-3 h-0.5 bg-gradient-to-r ${
                        feature.color
