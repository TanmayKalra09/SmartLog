...
export default function HomePage() {
  ...
  const features = [
    ...
    { icon: TrendingUp, title: 'Habit Tracker', desc: 'Insights that matter', color: 'from-blue-400 to-purple-500' },
    ...
    <div className="relative min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen text-center px-4">
        ...
        <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`}>
          ...
          <div className="grid grid-cols-2 md:grid-cols-2 gap-6 mb-16 max-w-5xl">
            {features.map((feature, index) => {
              ...
              return (
                <div
                  ...
                  onClick={() => {
                      if (feature.title === 'Track Expenses') {
                        navigate('/dashboard');
                      } else if (feature.title === 'Habit Tracker') {
